...
public class ShapeGenerator : MonoBehaviour
{
    ...
    private void DrawShapes()
    {
        ...
        if (_drawSphere != null)
        {
            var spherePoints = _drawSphere.GeneratePoints(_drawSphere.longitudeSegments, _drawSphere.latitudeSegments);
            DrawLine(spherePoints);
        }

        //Draw cylinder
        DrawLine(_drawCylinder.points);
    }
